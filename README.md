...
- [ ] Une image « [open graph](https://simplified.co/blog/design-hacks/open-graph-image-everything-you-need-to-know/) » de `1200px` \* `630px` est fourni au format JPEG. Elle sera utilisée par défaut lorsque le site sera partagé sur les réseaux sociaux.
